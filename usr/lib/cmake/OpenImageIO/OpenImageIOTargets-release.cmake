...
set_target_properties(OpenImageIO::OpenImageIO_Util PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libOpenImageIO_Util.so.2.2.18"
  IMPORTED_SONAME_RELEASE "libOpenImageIO_Util.so.2.2"
  )

list(APPEND _IMPORT_CHECK_TARGETS OpenImageIO::OpenImageIO_Util )
list(APPEND _IMPORT_CHECK_FILES_FOR_OpenImageIO::OpenImageIO_Util "${_IMPORT_PREFIX}/lib/libOpenImageIO_Util.so.2.2.18" )
...
set_target_properties(OpenImageIO::OpenImageIO PROPERTIES
  IMPORTED_LINK_DEPENDENT_LIBRARIES_RELEASE "OpenEXR::OpenEXR;OpenEXR::Iex;OpenEXR::IlmThread"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libOpenImageIO.so.2.2.18"
  IMPORTED_SONAME_RELEASE "libOpenImageIO.so.2.2"
  )

list(APPEND _IMPORT_CHECK_TARGETS OpenImageIO::OpenImageIO )
list(APPEND _IMPORT_CHECK_FILES_FOR_OpenImageIO::OpenImageIO "${_IMPORT_PREFIX}/lib/libOpenImageIO.so.2.2.18" )
...
set_target_properties(OpenImageIO::iv PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/iv"
  )

list(APPEND _IMPORT_CHECK_TARGETS OpenImageIO::iv )
list(APPEND _IMPORT_CHECK_FILES_FOR_OpenImageIO::iv "${_IMPORT_PREFIX}/bin/iv" )
